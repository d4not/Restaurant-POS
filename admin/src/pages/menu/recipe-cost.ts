 ...
 * src/modules/recipes/cost-engine.ts so the UI can show a live line cost as
 * the user edits. The backend is always authoritative — totals displayed at
 * the recipe level come from product.recipe_cost / variant.recipe_cost.
 */

import type { ContentUnit } from '../../types/inventory';
